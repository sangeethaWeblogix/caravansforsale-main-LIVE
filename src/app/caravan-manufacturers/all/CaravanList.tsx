...
function FeatureCard({ image, alt, title, subtitle, shortinfo, link }) {
...
export default function CaravanManufacturers() {
    return (
        <>
            ...
            {/* Grand Caravans Section */}
            <section className="related-products section-padding pb-0">
                <div className="container">
                    <div className="title mb-20">
                        <div className="tpof_tab">
                            <h3>Grand Caravans</h3>
                            <div className="viewall_bttn">
                                <Link href="https://www.caravansforsale.com.au/caravan-manufacturers/grand-caravans/">
                                    <i className="bi bi-chevron-right"></i>
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="range-list position-relative">
                        ...
                        >
                            <SwiperSlide>
                                <FeatureCard
                                    image="https://www.admin.caravansforsale.com.au/wp-content/uploads/2023/08/nomad.png"
                                    alt="Nomad - LUXURY OFF ROAD"
                                    title="Nomad - LUXURY OFF ROAD"
                                    subtitle="LUXURY OFF ROAD"
                                    shortinfo="Introducing the Nomad – a 17ft fully off-road, customisable couples caravan built in Australia using state-of-the-art 3D modelling software. This caravan is built to handle any terrain with its 6-inch chassis, Cruisemaster XT Freestyle Coil Suspension, and 16 inch all-terrain tyres."
                                    link="https://www.caravansforsale.com.au/range/nomad-grand-city-caravans/"
                                />
                            </SwiperSlide>

                            <SwiperSlide>
                                <FeatureCard
                                    image="https://www.admin.caravansforsale.com.au/wp-content/uploads/2023/08/1-42.png"
                                    alt="Royale - LUXURY OFF ROAD"
                                    title="Royale - LUXURY OFF ROAD"
                                    subtitle="LUXURY OFF ROAD"
                                    shortinfo="Introducing the Royale – a 19 ft 6 customisable couples caravan built in Australia using state-of-the-art 3D modelling technology. Available in your choice of your centre door or rear door, as well as L shape lounge or café dinette lounge."
                                    link="https://www.caravansforsale.com.au/range/royale-grand-city-caravans/"
                                />
                            </SwiperSlide>
                        </Swiper>
            ...
            {/* Pagination Section */} <section className="section-padding pb-0">
  <div className="container">
    <div className="pagination:container">
      ...
      <div className="pagination:number">
        <Link href="https://www.admin.caravansforsale.com.au/caravan-manufacturers/all/page-2/"> 2 </Link>
      </div>
      <div className="pagination:number">
        <Link href="https://www.admin.caravansforsale.com.au/caravan-manufacturers/all/page-3/"> 3 </Link>
      </div> {/* Add more pagination items here */} <div className="pagination:number arrow">
