...
export default function CaravanInfo() {
  useEffect(() => {
    ...
    Fancybox.bind("[data-fancybox='gallery']", {
      toolbar: {
        display: ["zoom", "close"], // show only zoom + close
      },
      thumbs: {
        type: "classic", // thumbnail style
      },
    });

    return () => {
      Fancybox.destroy(); // cleanup when component unmounts
    };
  }, []);
  return (
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-9">
            <div className="section-head">
              ...
              <p>
                Traveling with three kids and need space for adventure? The
                20.6F CALIBRA offers all the quality, style, and features of an
