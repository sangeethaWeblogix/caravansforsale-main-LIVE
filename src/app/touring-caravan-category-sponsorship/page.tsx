...
export const metadata: Metadata = {
  ...
  description:
    "Exclusive category page sponsorship for touring caravan manufacturers. Limited to just 1 advertiser per month — maximum exposure, retargeting included, and 100% share of voice in the touring caravan category.",
}
