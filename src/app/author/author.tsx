          ...
          <div className="section-head mb-60 style-5">
              ...
              <div className="author_head">
                ...
                <div>
                  ...
                  <h5 className="author-tagline">Author at Caravans For Sale</h5>
                </div>
              </div>

              <div className="author-info">
                <p>Tom is a passionate caravan enthusiast and content writer at <a href="https://www.caravansforsale.com.au/">CaravansForSale.com.au</a> — Australia’s trusted destination for buying, selling, and researching caravans.</p>
                <p>
                  He helps Australians make informed decisions across every stage of the caravan journey, from choosing the right model to comparing prices and discovering hidden gems from regional manufacturers.
                </p>
                <p>Tom’s articles focus on off-road caravans, touring models, hybrids, and family-friendly designs, offering practical insights tailored to Australian conditions, travel habits, and market trends.
                </p>
                <p>With a genuine love for the outdoors, Tom’s writing reflects Australia’s caravan lifestyle — adventure, community, and freedom on the open road.
                </p>
                        ...
                        <div className="col-lg-7">
                          <div className="card-body p-0">
                            <small className="d-block date text">
                              <Link href={href} className="text-uppercase border-end brd-gray pe-2 me-2 color-blue4">
                                Tom
                              </Link>
