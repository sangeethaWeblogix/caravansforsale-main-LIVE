...
const CITY_LINKS = getRegionsByState("tasmania");
...
const HOW_TO_STEPS = [
  ...
  { num: 3, iconSet: "fa-regular", icon: "fa-comment-dots",  title: "Reach Buyers",           desc: "Your listing is live across Tasmania. Buyers contact you directly." },
...
const MAIN_FAQS = [
  {
    q: "How do I sell my caravan in Tasmania?",
    a: <p>You can sell your caravan online by creating a private seller listing on CaravansForSale.com.au. Simply add your caravan details, upload clear photos, set your asking price, and publish your ad so active buyers across Tasmania and all of Australia can contact you directly.</p>,
  },
  {
    q: "How much does it cost to sell my caravan in Tasmania?",
  ...
  },
  {
    ...
    a: <p>Check similar caravans for sale in Tasmania before setting your price. Compare by make, model, year, condition, length, ATM, tare weight, sleeping capacity, features and location. A realistic asking price can help attract more genuine buyers.</p>,
  },
  {
    q: "Is it safe to sell my caravan privately online?",
    a: <p>Yes, but you should take normal precautions. Speak with buyers directly, meet in a safe location, confirm payment has cleared before handover and complete any required transfer paperwork for Tasmania.</p>,
  },
  {
...
export default function SellerTasmania() {
      ...
      <section className="demo-hero">
        <div className="container">
          <h1 className="demo-hero__title">
            Sell My Caravan in Tasmania
          </h1>
          <p className="demo-hero__subtitle">
            The fastest, safest way to reach active caravan buyers across Hobart and regional Tasmania.
          </p>
          ...
          <div className="demo-price-card">
            ...
            <div className="demo-price-card__left">
              <div className="demo-price-card__aus-circle">
                <img src="/images/tas_map.svg" alt="Tasmania" />
              </div>
              <div className="demo-price-card__header">
              <h3>Looking to sell your caravan?</h3>
            </div>
              <p className="demo-price-card__desc">
                List your caravan on Australia's #1 caravan marketplace and connect with thousands of buyers across Hobart and regional Tasmania.
              </p>
      ...
      <section className="demo-reach-section">
        <div className="container">
          ...
          <div className="demo-reach-heading">
            <h3>Reach Caravan Buyers Across Tasmania, Including: </h3>
          </div>
  ...
  {/* ── Region + City links ── */}
          ...
          <div className="demo-guide-grid">
            ...
            <div className="demo-guide-card">
              ...
              <ul className="demo-guide-card__list">
                ...
                <li>Targeted caravan buyers across Hobart and regional Tasmania.</li>
            ...
            <div className="demo-guide-card">
              ...
              <ul className="demo-guide-card__list">
                <li>Check similar caravans for sale in Tasmania.</li>
      ...
      <section className="demo-faq-section">
        <div className="container">
          <div className="demo-faq-head">
            ...
            <p>Everything you need to know about selling your caravan in Tasmania on CaravansForSale.com.au</p>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-md-6">
              <img src="/images/your-caravan-desktop-seller-2.jpg" className="img-fluid demo-why-img" alt="Tasmanian caravan buyers" />
            </div>
            <div className="col-md-6">
              <h2>Why Tasmanian Caravan Buyers Visit CaravansForSale Every Month</h2>
              <p>
                CaravansForSale.com.au helps Tasmanian caravan sellers reach buyers searching for
                used caravans, off road caravans, family caravans, pop tops, hybrids and touring
                caravans across Hobart and regional Tasmania.
              </p>
              <div className="demo-check-grid demo-check-grid--2col mt-3">
                {[
                  "Thousands of active buyers", "Local reach across TAS regions",
      ...
      <section className="demo-steps-section">
        <div className="container">
          ...
          <p className="demo-steps-subtitle">List in minutes and reach thousands of active caravan buyers in Tasmania.</p>
      ...
      <section className="demo-cta-strip">
        <div className="container text-center">
          <p>
            Start selling your caravan in Tasmania today for just{" "}
          ...
          <p className="demo-cta-strip__alt-link">
            Not in TAS? Sell your caravan across Australia <a href="/sell-my-caravan/">here</a>.
          </p>
        </div>
      </section>
